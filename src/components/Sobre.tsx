        ...
        <ul className='mt-3 flex items-stretch'>
          <li className="mr-3 text-xs">
            <a href="https://github.com/HenrikSantos" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="#d5f6ff" className="size-6" aria-hidden="true">
          ...
          <li className="mr-3 text-xs">
            <a href="https://www.linkedin.com/in/henrik-santos-dev/" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#d5f6ff" className="size-6" aria-hidden="true">
          ...
          <li className="mr-3 text-xs">
            <a href="https://www.youtube.com/@gimmicodando730" target="_blank" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" height="800" width="1200" fill="#d5f6ff" className="size-7" viewBox="-35.20005 -41.33325 305.0671 247.9995">
