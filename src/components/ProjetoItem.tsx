...
export default function ProjetoItem({
  ...
  return (
    <div
      className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-xl backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[var(--emphasis)]/50 hover:bg-white/10 hover:shadow-2xl hover:shadow-[var(--emphasis)]/10"
      onClick={onClick}
